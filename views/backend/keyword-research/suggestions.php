<div class="scribe-wrap">
	...
	<div class="scribe-link-building-tabs" data-link-building-complete="true">
		<h3 class="nav-tab-wrapper scribe-link-building-tabs-identifiers">
			...
			<a class="nav-tab" href="#scribe-keyword-research-twitter" id="scribe-keyword-research-twitter-tab-identifier"><?php esc_html_e('Twitter', 'scribeseo'); ?></a>
			<a class="nav-tab" href="#scribe-keyword-research-google-plus" id="scribe-keyword-research-google-plus-tab-identifier"><?php esc_html_e('Google+', 'scribeseo'); ?></a>
				...
				<?php } else { ?>
					...
					<tr valign="top">
						...
						<td class="scribe-keyword-suggestions-keyword">
							<a rel="twipsy" title="<?php esc_attr_e('More Details', 'scribeseo'); ?>" href="<?php scribe_the_upload_iframe_src('scribe-keyword-suggestions', 'scribe-keyword-details', array('scribe-keyword' => $queried_keyword, 'scribe-details-keyword' => $keyword->term, 'scribe-details-previous' => $previous)); ?>"><?php echo esc_html( $keyword->term ); ?></a>
						</td>
		...
		<div class="scribe-link-building-tab-section" id="scribe-keyword-research-twitter">
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row"><label for="scribe-keyword-research-twitter-headlines-term"><?php esc_html_e('Headline Suggestions for', 'scribeseo'); ?></label></th>
						<td>
							<select class="scribe-keyword-research-headlines-term-select scribe-select-new" id="scribe-keyword-research-twitter-headlines-term">
								<?php foreach($keywords as $keyword) { ?>
							...
							<a class="scribe-help-marker" href="#" data-placement="left" rel="popover" data-content="<?php esc_attr_e( 'Find out what people are tweeting for this keyword.', 'scribeseo' ); ?>" title="<?php esc_attr_e('Twitter', 'scribeseo' ); ?>">?</a>
						</td>
			...
			<div id="scribe-keyword-suggestions-twitter-widget-container">
				<script type="text/javascript">
					window.twitter_widget = new TWTR.Widget({
						version: 2,
						type: 'search',
						search: '',
						interval: 250,
		...
		<div class="scribe-link-building-tab-section" id="scribe-keyword-research-google-plus">
			<?php wp_nonce_field('scribe-research-google-plus', 'scribe-google-plus-nonce'); ?>
			<table class="form-table">
				<tbody>
					<tr valign="top">
