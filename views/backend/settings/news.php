<div class="wrap">
	...
	<h2 id="scribe-seo-news-headline">
		<?php echo wp_kses( __('Scribe - SEO News - Brought to you by <a href="http://www.searchenginejournal.com">Search Engine Journal</a>', 'scribeseo'), Scribe_SEO::formatting_allowedtags() ); ?>
	</h2>
